...
// const birthdayDate = new Date("2025-01-01T00:00:00"); // Ganti dengan tanggal ulang tahun
...
//     confettiContainer.appendChild(confettiTemplate);
// });
// Elemen untuk ucapan ulang tahun
...
// Sembunyikan pesan ulang tahun di awal
...
function updateCountdown() {
    ...
    // Jika sudah mencapai tanggal, tampilkan ucapan ulang tahun
    if (timeDiff <= 0) {
        clearInterval(countdownInterval);
        countdownElement.innerHTML = "<h2>Happy Birthday!</h2>";
        messageBox.style.display = "block"; // Tampilkan ucapan ulang tahun
    }
}
